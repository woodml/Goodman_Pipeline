...
# out_file = '/Users/woodml/Observing/Reduced/' + folder + '/' + target + '_rvspectra.fits'
# hdul = fits.open(out_file)
# data = hdul['SPECTRUM'].data
# wv = [x[0] for x in data]
# spec = [x[1] for x in data]
...
# Halpha
out_file = '/Users/woodml/Observing/SOAR:Goodman/Reduced/' + date + '/' + target + '_spectra_ha.pdf'
plt.figure(figsize=(10, 4))
plt.plot(wv, spec)
plt.minorticks_on()
...
# Li
out_file = '/Users/woodml/Observing/SOAR:Goodman/Reduced/' + date + '/' + target + '_spectra_li.pdf'
plt.figure(figsize=(10,4))
plt.plot(wv, spec)
...
# TiO
out_file = '/Users/woodml/Observing/SOAR:Goodman/Reduced/' + date + '/' + target + '_spectra_tio.pdf'
plt.figure(figsize=(10, 4))
plt.plot(wv, spec)
plt.vlines([6562.8, 6708, 7126], 0, 1000, color='k', ls='--')
plt.minorticks_on()
